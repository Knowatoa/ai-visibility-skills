...
pptx: a stamp-grid sorter grouped by beat and Hit/why so you
can merge a run or move a look, and a one-look walk (the slide
before, this one, the one coming up). Then a PowerPoint: a cue,
not the spoken line, about 15-30 seconds a look, a visual note
for a later pass, notes that point back at the beat and the
outline block. The click count from length and pace is a guide.
If reading the deck aloud is giving the talk, the speech is on
the slides.
